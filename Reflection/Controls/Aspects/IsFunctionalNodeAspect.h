...
namespace DNVS {namespace MoFa {namespace Reflection {namespace Controls {
    ...
    class REFLECTION_IMPORT_EXPORT IsFunctionalNodeAspect : public IControlAspectT<IsFunctionalNodeAspect>
    {
    public:
        const Attributes::AttributeCollection& GetAttributeCollection() const override;
        bool operator==(const IsFunctionalNodeAspect& other) const override;
