...
namespace DNVS {namespace MoFa {namespace Reflection { namespace Contents { 
    class REFLECTION_IMPORT_EXPORT TypedLookupContent : public IContent
    {
    public:
        TypedLookupContent(const std::string& text, const Types::DecoratedTypeInfo& typeInfo);
