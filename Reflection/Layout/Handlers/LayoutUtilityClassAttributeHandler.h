...
namespace DNVS {namespace MoFa {namespace Reflection {namespace Layout {
    //Enums are treated as RadiuButtons by default.
    class LayoutUtilityClassAttributeHandler : public LayoutHandler<LayoutUtilityClassAttributeHandler, AutoControl> {
    public:
