...
namespace DNVS {namespace MoFa {namespace Units { namespace Reflection {
    ...
    void ReflectStress( DNVS::MoFa::Reflection::TypeLibraries::TypeLibraryPointer typeLibrary )
    {
        ReflectPhenomenon<StressPhenomenon>(typeLibrary);
    }
