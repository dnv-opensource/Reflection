...
namespace DNVS {namespace MoFa {namespace Units { namespace Reflection {
    ...
    void ReflectTempDiff( DNVS::MoFa::Reflection::TypeLibraries::TypeLibraryPointer typeLibrary )
    {
        ReflectPhenomenon<TempDiffPhenomenon>(typeLibrary);
    }
